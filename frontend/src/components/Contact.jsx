...
const Contact = () => {
  ...
  <div className="text-white absolute w-full hero-gradient h-full scroll-smooth">
       <div className={`bg-white absolute z-11 p-3 transition-all duration-500 ${hamValue?"top-[55px] right-0 block ease-out":"top-[-10%] hidden"}`}>
    ...
    <div className="mt-20 absolute h-fit w-full">
      ...
      <div className="w-[80vw] border-4 shadow-md shadow-purple-500 p-5 about-cont-text mx-auto rounded-xl text-2xl flex flex-col gap-10 mt-3">
      <span>
   ...
   Got a question, idea, or just want to say hi? I’d love to hear from you. Whether it's feedback, feature requests, or collaboration opportunities — feel free to reach out.
       ...
       <div className="font-audiowide text-[13rem] letsnote-text text-[#a9a6a6] mt-10 text-center">
        LETSNOTE
       </div>
    </div> 
