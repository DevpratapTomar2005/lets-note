...
const Contact = () => {
  ...
  <div className="text-white absolute pb-50 w-full hero-gradient overflow-hidden scroll-smooth">
    <div className="mt-20 absolute w-full">
      ...
      <div className="w-[80vw] border-4 shadow-md shadow-purple-500 p-5 mx-auto rounded-xl text-2xl flex flex-col gap-10 mt-3">
      <span>
