...
const LandingHome = () => {
  ...
  return (
    ...
    <div className="bg-[#121212] landing-page text-white relative top-0 scroll-smooth overflow-hidden">
      ...
      <div className={`bg-white p-3 absolute ${hamValue?"top-[1%] right-0 block transition-all duration-500 ease-in-out":"top-[-10%] hidden"}`}>
      ...
      <div className="py-20">
        ...
        <div className="w-[70%] desp-img self-center shadow-[2px_3px_10px_rgba(0,0,0,0.2)] shadow-purple-400">
      ...
      <div className="py-20 my-10">
        ...
        <div className="w-[70%] self-center desp-img shadow-[2px_3px_10px_rgba(0,0,0,0.2)] shadow-purple-400">
          <img src="https://www.websitecdn.com/website-com/website-builder-articles/overview/what-features/website_com_templates.webp" alt="document-note img" />
        </div>
        <div className="w-1/2 desp-text">
      ...
      <div className="mt-30 pt-5">
        ...
        <div className="flex flex-col footer-cont items-center gap-7">
          ...
          <div className="font-audiowide text-[13rem] text-[#a9a6a6] letsnote-text w-full text-center mt-20">
           LETSNOTE
          </div>
